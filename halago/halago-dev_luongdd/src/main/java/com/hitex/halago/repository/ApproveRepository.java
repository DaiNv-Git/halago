...
public interface ApproveRepository extends CrudRepository<Approve, String> {
    ...
    @Query("Select approve from Approve approve where approve.idCampaign=:idCampaign and approve.idInfluencer=:idInfluencer")
    Approve checkApprove(int idCampaign,int idInfluencer);

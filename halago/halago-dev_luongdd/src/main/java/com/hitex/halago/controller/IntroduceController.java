...
//                        introduce.setImgFive(setImgSeo(jsonNode.get("imgFive").get("img").asText(),jsonNode.get("imgFive").get("title").asText()));
                        introduce.setImgSecond(jsonNode.get("imgSecond").asText()+"#a");
                        introduce.setImgThird(jsonNode.get("imgThird").asText()+"#a");
                        introduce.setImgFour(jsonNode.get("imgFour").asText()+"#a");
                        introduce.setImgFive(jsonNode.get("imgFive").asText()+"#a");
                        introduce.setContent(jsonNode.get("content").asText()+"#a");
...
//                        introduce.setImg(setImgSeo(jsonNode.get("img").get("img").asText(),jsonNode.get("img").get("title").asText()));
                        introduce.setImg(jsonNode.get("img").asText()+"#a");
...
//                        introduce.setImgTwelve(setImgSeo(jsonNode.get("imgTwelve").get("img").asText(),jsonNode.get("imgTwelve").get("title").asText()));
                        ...
                        introduce.setImgFour(jsonNode.get("imgFour").asText()+"#a");
                        introduce.setImgFive(jsonNode.get("imgFive").asText()+"#a");
                        introduce.setImgSix(jsonNode.get("imgSix").asText()+"#a");
                        introduce.setImgSeven(jsonNode.get("imgSeven").asText()+"#a");
                        introduce.setImgEight(jsonNode.get("imgEight").asText()+"#a");
                        introduce.setImgNine(jsonNode.get("imgNine").asText()+"#a");
                        introduce.setImgTen(jsonNode.get("imgTen").asText()+"#a");
                        introduce.setImgEleven(jsonNode.get("imgEleven").asText()+"#a");
                        introduce.setImgTwelve(jsonNode.get("imgTwelve").asText()+"#a");
                    }else{
                        introduce.setTitle(jsonNode.get("title").asText());
                        introduce.setContent(jsonNode.get("content").asText());
                        lang.setTitle(jsonNode.get("title_en").asText());
